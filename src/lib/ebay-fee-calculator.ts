...
export function calculateMonthlyFeeSummary(
  ...
  const feeBreakdown: Record<EbayFeeType, number> = {
    FINAL_VALUE_FEE: 0,
    FINAL_VALUE_FEE_FIXED_PER_ORDER: 0,
    FINAL_VALUE_SHIPPING_FEE: 0,
    PAYMENT_PROCESSING_FEE: 0,
    INTERNATIONAL_FEE: 0,
    INSERTION_FEE: 0,
    BOLD_FEE: 0,
    GALLERY_FEE: 0,
    FEATURED_GALLERY_FEE: 0,
    SUBTITLE_FEE: 0,
    LISTING_UPGRADE_FEE: 0,
    BELOW_STANDARD_FEE: 0,
    BELOW_STANDARD_SHIPPING_FEE: 0,
    HIGH_ITEM_NOT_AS_DESCRIBED_FEE: 0,
    HIGH_ITEM_NOT_AS_DESCRIBED_SHIPPING_FEE: 0,
    AD_FEE: 0,
    PROMOTED_LISTINGS_FEE: 0,
    STORE_SUBSCRIPTION_FEE: 0,
    EXPRESS_PAYOUT_FEE: 0,
    BANK_PAYOUT_FEE: 0,
    REGULATORY_OPERATING_FEE: 0,
    TAX_DEDUCTION_AT_SOURCE: 0,
    INCOME_TAX_WITHHOLDING: 0,
    VAT_WITHHOLDING: 0,
    PAYMENT_DISPUTE_FEE: 0,
    FINANCE_FEE: 0,
    CHARITY_DONATION: 0,
    OTHER_FEES: 0
  };
